/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 5528588920fdd41b4517b85d6215a16f)
...
interface __BaseEnv_Env {
	 ...
	 * src/worker/index.ts). Never set by wrangler.toml; deleted together with
	 * the route in Phase 4 of specs/cleanup/MVP_CLEANUP_PLAN.md.
	 */
	WORKER_TEST_MODE?: string;
	GAME_ROOM: DurableObjectNamespace<import("./src/worker/index").GameRoomDurableObject>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_ENV">> {}
}
